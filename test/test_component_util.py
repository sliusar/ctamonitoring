...
from ctamonitoring.property_recorder.frontend_exceptions import (
    UnsupporterPropertyTypeError, ComponentNotFoundError, WrongComponentStateError)
...
def get_mock_acs_component():    
    ...
    '''
    attrs = {'_get_' + prop_name + '.return_value' : get_mock_property(props_repo_ids[prop_name]) 
