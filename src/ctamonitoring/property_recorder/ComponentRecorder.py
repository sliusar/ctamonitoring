...
I judged that was less confusing to have the package name to follow the Class naming convention
than the other way around.
"""


class ComponentRecorder(actl__POA.PropertyRecorder,
    ...
    def initialize(self):
        ...
        #TODO: this can raises a BadCdbRecorderConfig, think how to handle
        self._logger = self.getLogger()
     
        
        self._recorder_config = RecorderConfigDecoder.get_cdb_data(self.getName())
        ...
        #create recorder object, use this component as 'client' 
    ...
    def addComponent(self, componentId):
        ...
        Raises:
            ACSErrTypeCommon::CouldntPerformActionEx -- if component could noe be added
        """
...
class RecorderConfigDecoder(object):
    ...
    def get_cdb_data(component_name):
        ...
        try:
            recorder_config.backend_type = EnumUtil.from_string(BackendType, 
                                            componentCDB.firstChild.getAttribute(
                                            "backend").decode())
        except Exception as e:
        ...
        try:
            recorder_config.backend_config = ast.literal_eval(componentCDB.firstChild.getAttribute(
